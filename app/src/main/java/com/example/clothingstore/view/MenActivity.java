...
public class MenActivity extends AppCompatActivity {
    ...
    private List<Article> fullArticleList = new ArrayList<>(); // All men's clothing articles
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        articleViewModel.getArticles().observe(this, new Observer<List<Article>>() {
            ...
            public void onChanged(List<Article> articles) {
                if (articles != null) {
                    // Filter articles based on the "Men's Clothing" category
                    fullArticleList.clear();
                    for (Article article : articles) {
                        if ("men's clothing".equalsIgnoreCase(article.getCategory())) {
                            fullArticleList.add(article);
                        }
                    }
                    filterArticles(searchFilter.getText().toString()); // Apply initial filter
                }
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.loginButton) {
            Intent intent = new Intent(MenActivity.this, LoginActivity.class);
            startActivityForResult(intent, LOGIN_REQUEST);
        } else if (item.getItemId() == R.id.logoutButton) {
            new AlertDialog.Builder(MenActivity.this)
                    .setTitle("Logout")
            ...
            Intent intent = new Intent(MenActivity.this, AddArticleActivity.class);
            ...
            Intent intent = new Intent(MenActivity.this, CartActivity.class);
            startActivity(intent);
        }
