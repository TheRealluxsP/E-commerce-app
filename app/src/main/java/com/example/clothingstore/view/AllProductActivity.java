...
public class AllProductActivity extends AppCompatActivity {
            ...
            public void onChanged(List<Article> articles) {
                if (articles != null) {
                    ...
                    for (Article article : articles) {
                        if (!"electronics".equalsIgnoreCase(article.getCategory())) {
    ...
    private void setupNavigationButtons() {
        ...
        btnWomen.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(AllProductActivity.this, WomenActivity.class);
        ...
        btnMen.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(AllProductActivity.this, MenActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btnAccessories.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                Intent intent = new Intent(AllProductActivity.this, AccessoriesActivity.class);
                startActivity(intent);
                finish();
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.loginButton) {
            ...
            new AlertDialog.Builder(AllProductActivity.this)
                    .setTitle("Logout")
            ...
            Intent intent = new Intent(AllProductActivity.this, AddArticleActivity.class);
            startActivityForResult(intent, ADD_ARTICLE_REQUEST);
        } else if (item.getItemId() == R.id.profileButton) {
            Intent intent = new Intent(AllProductActivity.this, ProfileActivity.class);
            startActivity(intent);
