...
public class AccessoriesActivity extends AppCompatActivity {
    ...
    private List<Article> fullArticleList = new ArrayList<>(); // All articles in the jewelry category
    private List<Article> filteredArticleList = new ArrayList<>(); // Filtered articles
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Set up RecyclerView adapter with the filtered list
        articleAdapter = new ArticleAdapter(this, filteredArticleList);
            ...
            public void onChanged(List<Article> articles) {
                if (articles != null) {
                    ...
                    for (Article article : articles) {
                        if ("jewelery".equalsIgnoreCase(article.getCategory())) {
    ...
    private void setupNavigationButtons() {
        ...
        btnMen.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AccessoriesActivity.this, MenActivity.class);
        ...
        btnWomen.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(AccessoriesActivity.this, WomenActivity.class);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.loginButton) {
            ...
            Intent intent = new Intent(AccessoriesActivity.this, AddArticleActivity.class);
            startActivityForResult(intent, ADD_ARTICLE_REQUEST);
        } else if (item.getItemId() == R.id.profileButton) {
            Intent intent = new Intent(AccessoriesActivity.this, ProfileActivity.class);
            startActivity(intent);
        }else if (item.getItemId() == R.id.userCartButton) {
            Intent intent = new Intent(AccessoriesActivity.this, CartActivity.class);
            startActivity(intent);
        }
